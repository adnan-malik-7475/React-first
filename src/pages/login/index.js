...
let Login =()=>{
    ...
    <div className=" pl-80">
                      <button
                  type="button"
                  className="text-white bg-blue-900 hover:bg-blue-900 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 ml-40 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
          ...
          <div  className="bg-gray-00 w-full flex justify-center items-center  min-h-screen">
            ...
            <div className="w-full max-w-lg " >
              <form onSubmit={onSubmit}
                ...
                <h3 className="text-center font-extrabold text-3xl text-yellow-400 mb-6">Login</h3>
                <div className="mb-4">
                ...
                <p className="text-center mt-3  text-lg font-bold">If You don't have an Account <Link className='text-green-400 ml-2' to={'/register'}><u>Register</u></Link> </p>
              </form>
